...
export function BattleMap() {
  ...
  }, [selectedTokenId, selectedTemplateId, removeToken, removeTemplate, showInitForm, activePcMove]);
        ...
        <div className="bm-toolbar">
          ...
          <div className="bm-toolbar__group">
            ...
            {selectedTokenId && (() => {
              ...
              if (isPC) return null; // PC actions handled by battle mode toggle
              return (
                <>
                  <span className="bm-toolbar__div" />
                  <button
